...
public class Array16LottoAnswer {
    public static void main(String[] args) {
        // 일단 로또 한 게임을 완성하기 위해서는 6번 반복이
        // 일어나야 합니다.

        // 근데 6 번 반복한 것은 한 게임을 위한거고, 그 게임을 5번 반복한다고 가정하겠습니다.
        // 그렇다면 기본적으로 30번 번호가할당되어야 함을 의미합니다.
        ...
        // 그 결과 반복문 외부에서 sout 했을 때 가장 최근 게임의 결과값이 나오는 점이라고 할 수 있겠네요.
    }
}
