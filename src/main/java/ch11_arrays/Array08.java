...
/*
    ...
    일반 for 문 과의 차이점 :
        ...
        이를 응용해서 배열 내의 element에 for 문 내부에서만 사용하는 변수에
...
public class Array08 {
    public static void main(String[] args) {
        ...
        for(int number : nums) {        // 자료형과 변수명이니까 선언했다고 볼 수 있겠네요.
...
//        System.out.println(number);   오류발생.
        /*
            ...
            두 번째 반복으로 넘어가서 nums의 1번지에 2가 number에 재대입됩니다.
            ...
            num의 199번지에 있는 200이 number에 재대입되고 출력됩니다.
