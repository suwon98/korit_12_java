...
public class Array01 {
    public static void main(String[] args) {
        ...
        /*
            ...
            불가능합니다.
            즉 elemenet를 확인하기 위해서는 배열 내부로 직접 탐색하는 과정이 필요합니다.
        ...
        // element의 개수를 마음대로(많이), 그리고 가독성 없게 작성했다고 치면
        // 직접 한계값을 하드코딩해서 집어넣기가 번거러움

        // 컴퓨터한테 직접 한계값을 구해서 알아서 출력하도록 명령을 내릴 필요가 있다
        ...
        // 정답 : 의미없음 / 다마나 중요한 것은 처음 값을 대입하는데도 int arr03[0] = 10; 이
        // 아니라는 점입니다.
