    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < scores.length; i++) {
            if (scores[i] < 0 || scores[i] > 100)
                ...
                else grades[4]++;    // grads[] 안에 i가 아니라 0으로 하드코딩 해야합니다.
            }
        }
        System.out.println("A등급 " + grades[0] + " 명");
        System.out.println("B등급 " + grades[1] + " 명");
        System.out.println("C등급 " + grades[2] + " 명");
        System.out.println("D등급 " + grades[3] + " 명");
        System.out.println("F등급 " + grades[4] + " 명");
    }
}
