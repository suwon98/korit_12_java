...
public class CentralControlMain {
    public static void main(String[] args) {
        ...
        // 이하의 코드는 비어있는 배열을 CentralControl 클래스의 field인 deviceArray에 집어넣엇네요.
...
//        centralControl1.deviceArray   에 접근하는 것이 불가능합니다. 접근 제어자가 private이기 때문에
        // 그렇다면 centralControl1.deviceArray에 Power의 하위 클래스인 AirConditioner 등의 객체를 집언허기 위해서는
        ...
        System.out.println("---------- Printer / Speaker 포함 후 -------------");
