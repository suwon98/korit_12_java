...
public class StrMap {
    public static void main(String[] args) {
        ...
        // 이상의 코드는 set 하나 새성하는데, 내부의 Key가 String, Value가 String인 Map이
