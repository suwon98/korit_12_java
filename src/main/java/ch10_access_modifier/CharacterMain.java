...
/*
    ...
    1. field
        ...
        Character 클래스에서 인스턴스인 warrior를 생성
        이름 : 전사
        체력 : 100
        공격력 : 200
        스킬 : 세로 베기
...
class Character {
    ...
    private void gainExp(int amount) {  // method에 private 적용
        exp += amount;
        System.out.println(name + " 이(가) 경험치" + amount + " 를 얻었습니다.");
    }
    // 두 가지 방식 중에 하나만 적용하면 됨.
    public void attack() {
        System.out.println(name + " 이(가) " + power + "로 공격 !");
        gainExp(10);    // 그래서 공격 할 때 마다 10씩만 추가되겠네요.
        ...
        System.out.println(name + " 이(가) 경험치" + 10 + " 를 얻었습니다.");
    }
...
//        warrior.setExp(30);
        ...
        // 여기에 10000000 같은 식으로 입력하면 부정 사용이 될 것 같다.

        System.out.println(warrior.getHealth());
        warrior.attack();
//        warrior.gainExp(10);  경험치를 얻는 메서드는 attack() 메서드를
