...
/*
    주석(comment) : Java 프로그램의 경우 폴도 및 파일의 전체 코드를 컴파일링
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        /*
            이상의 코드에서 알수 있는 것처럼 컴퓨터는 생각보다 멍청합니다.
            ...
            큰 따옴표("")는 "문자열"을 표시하기 위한 기호라고 알아두면 되겠습니다.

            그리고, sout()의 () 내부에서 가장 먼자 나온 데이터의 자료형을 따라간다는 점도 확인할 수 있습니다.
