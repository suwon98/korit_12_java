...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            이상의 개념은 익명 클래스로 Java1.1 -> 근데 이 형식은 자주 쓰인다기 보다 추후 학습할
            람다식(Lambda Expression)으로 대체되는 경우가 많습니다
            (그리고 JavaScript에서도 동일한 방식을 사용합니다.)

            재사용하지 않고 한 번만, 즉 이 경우에는 FactoryMain 에서만 한 번 쓰고 치운다면 사용하기 좋습니다.
        ...
        // 그리고 추상 클래스가 자식 클래스 에서 구현부를 작성했으므로
        // 재정의된 대로 출력되는지 확인
        ...
        /*
            ...
            상송을 전제로 한다는 것을 알 수 있습니다. 하지만 Java 버전 업에
            따라 익명 클래스를 통해 FactroyMain에서만 임시적으로 쓸 수 있는
            객체를 생성하는 것도 가능합니다.

            그리고 메서드 오버라이딩의 경우 '재정의'를 전제로 하고 있기 때문에
            부모 클래스와 자식 클래스의 메서드 호출 결과과 '다르게' 굴러 갈 경우에만
